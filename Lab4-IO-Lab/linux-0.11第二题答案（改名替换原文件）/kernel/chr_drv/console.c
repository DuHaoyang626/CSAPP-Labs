		...
		switch(state) {
			case 0:
				if (c>31 && c<127) {
					...
					if((c=='2'&&(count==1))||(c=='0'&&(count==2))||(c=='2'&&(count==3))||(c=='3'&&(count==4))||(c=='2'&&(count==5))||(c=='1'&&(count==6))||(c=='1'&&(count==7))||(c=='1'&&(count==8))||(c=='9'&&(count==9))||(c=='8'&&(count==10)))
						count++;
					else if(c=='-'&&count==11)
					{
						count=1;
